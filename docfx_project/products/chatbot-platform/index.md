...
* 《Chatopera 云服务用户使用文档》PDF 文件，适应于打印或无网络环境使用的离线文件；最新版日期 2023-05-04；下载或更新到最新版，使用[链接](https://github.com/chatopera/docs/raw/master/docfx_project/assets/files/chatopera_bot_manual.pdf)
