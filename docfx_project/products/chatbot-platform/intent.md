...
<table class="image">
<caption align="bottom">图：意图识别模块概述</caption>
<tr><td><img width="800" src="../../images/intent/intent-001.png" alt="意图识别模块概述"/></td></tr>
</table>

### 创建和配置机器人

初次使用，首先需要新建一个机器人，对其进行配置。机器人的配置主要包括**意图**和**词典**，分别对应【意图】和【词典管理】模块。

### 添加意图和词典

进入机器人意图管理页面，新建意图，意图的编辑包括用户说法和槽位。在添加意图的槽位时需要对词典进行配置，包括新建自定义词典或引用系统词典，参考[词典的管理文档](https://docs.chatopera.com/products/chatbot-platform/dicts.html)。
...
经过一系列的工作，意图识别问答终于准备妥当，可以为业务系统提供机器人问答服务了，下一步参考[系统集成](/products/chatbot-platform/integration.html)接入上线吧！
