...
Chatopera 云服务的 API 包括：1）对话检索 API；2）语音识别 API。
...
当前 Chatopera 云服务对话检索 API 有 **按天计费** 和 **包年套餐** 两种充值形式。
...
每日单个用户可以免费请求对话检索 API 1000 次，即免费额度；单日 >1000 次的部分按照每条 1 分钱计算，多出的部分按量收费，按日结算，每天生成账单。
...
| 简称 | 套餐（条/年） | 费用    | 相对于按天计费的优惠 |
| ------------- | ------------- | ------- | -------------------- |
| 套餐 A | 100W/年       | 0.6W 元 | 350 元               |
| 套餐 B | 500W/年       | 4W 元   | 6350 元              |
...
Chatopera 云服务包括每日**免费请求**和**付费请求**，当日超过免费请求部分进行计费，并在每晚23：59执行扣费。所以，对当日超过了免费额度的请求，Chatopera 云服务不会立即扣费，为了保证 Chatopera 云服务为客户提供稳定连续的服务，尤其是付费用户的权益，Chatopera 云服务使用保证金机制：**Chatopera 云服务用户的对话检索或语音识别服务超过当日免费额度情况下，只有用户余额大于等于保证金的前提下，Chatopera 云服务才正常处理用户的请求；对于不满足这个条件的云服务用户，当日请求大于免费额度的部分将返回异常提醒。**
