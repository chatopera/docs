...
当前 Chatopera 云服务对话检索 API 有 **按天计费** 和 **包年套餐** 两种购买形式。
...
每日单个用户可以免费请求对话检索 API 1,000 次，即免费额度；单日 >1,000 次的部分按照每条 1 分钱计算，多出的部分按量收费，按日结算，每天生成账单。
...
- *相对于按天计费的优惠*是相对于**按天计费**的情况，前 1,000 条免费，超过后每条 1 分钱，购买套餐能省的钱
