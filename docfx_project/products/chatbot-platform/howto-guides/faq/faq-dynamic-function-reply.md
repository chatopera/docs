...
下一步，就可以接入到业务系统。在返回结果中，除了使用文本的形式，还可以支持自定义的数据结构，返回结果支持展示为卡片、图文、按钮、列表的形式，详细参考[链接](https://docs.chatopera.com/products/chatbot-platform/howto-guides/convs/conv-richmedia.html)。
