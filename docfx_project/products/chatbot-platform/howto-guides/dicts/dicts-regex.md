...
Chatopera 机器人平台中，正则表达式词典支持的表达式规范为[PCRE](https://docs.chatopera.com/products/chatbot-platform/howto-guides/dicts/dicts-regex.html#pcre) 标准。
...
| 项目     | 表达式                                                   |
| -------- | -------------------------------------------------------- |
| [手机号](https://zhuanlan.zhihu.com/p/54505055)     | `(?:\+?86)?1(?:3\d{3}|5[^4\D]\d{2}|8\d{3}|7[^0129\D](?(?<=4)(?:0\d|1[0-2]|9\d)|\d{2})|9[189]\d{2}|66\d{2})\d{6}` |
