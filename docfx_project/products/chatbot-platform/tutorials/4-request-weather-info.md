...
假设你已经完成了上一步，已经了解意图创建和训练的过程，下面就不赘述详细的操作，只给出必要的信息。
...
进入春松机器人管理控制台，测试对话页面。选择【意图识别】，发送“北京的天气”。
...
在这个对话中，机器人在识别意图和城市后，请求第三方接口，通过互联网 HTTP API 的形式，查询天气信息，这个第三方接口需要认证，我们使用环境变量添加认证信息。
