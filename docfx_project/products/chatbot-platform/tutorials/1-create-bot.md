...
拷贝 `Client Id` 和 `Secret` 到多轮对话设计器【添加表单】，点击确认。然后，多轮对话设计器会跳转到春松机器人的对话脚本管理页面。这里你也可能遇到问题，比如提示[【信息不匹配，请确认机器人信息】](#信息不匹配请确认机器人信息)，参考本文后面的[《可能遇到的问题》](#可能遇到的问题)获得解决方案。如果遇到了其它问题，参考[帮助](/products/chatbot-platform/index.html#帮助)获得更多支持。
