...
默认的详情页显示的是机器人的对话语料统计与访问请求统计信息，在详情页，可以通过机器人的菜单，导航至机器人的其它页面，比如【机器人设置页面】。在后文，使用`春松机器人管理控制台`来指代示例程序的详情页。
...
拷贝 `Client Id` 到多轮对话设计器【添加表单】，拷贝 `Secret` 到多轮对话设计器【添加表单】，点击确认。然后，多轮对话设计器会跳转到春松机器人的对话脚本管理页面。这里你也可能遇到问题，比如提示[【信息不匹配，请确认机器人信息】](#信息不匹配请确认机器人信息)，参考本文后面的[《可能遇到的问题》](#可能遇到的问题)获得解决方案。如果遇到了其它问题，参考[帮助](/products/chatbot-platform/index.html#帮助)获得更多支持。
