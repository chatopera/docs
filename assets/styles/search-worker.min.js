 ...
 * https://github.com/dotnet/docfx/blob/da4a79677136eddcb56f413c36b1d084ad32bb31/templates/default/src/search-worker.js
 */
(()=>{
    var $ = (t,e)=>()=>(e || t((e = {
        exports: {}
    ...
    var W = $((q,M)=>{
        (function() {
            ...
            ,
            t.FieldRef = function(e, r) {
                this.docRef = e,
                this.fieldName = r,
                this._stringValue = r + t.FieldRef.joiner + e
            }
            ,
            t.FieldRef.joiner = "/",
            ...
            t.idf = function(e, r) {
                var i = 0;
                for (var s in e)
                    s != "_index" && (i += Object.keys(e[s]).length);
                var n = (r - i + .5) / (i + .5);
            ...
            t.tokenizer = function(e) {
                ...
                if (Array.isArray(e))
                    return e.map(function(u) {
                        return new t.Token(t.utils.asString(u).toLowerCase())
                    });
                for (var r = e.toString().trim().toLowerCase(), i = r.length, s = [], n = 0, o = 0; n <= i; n++) {
                    var a = r.charAt(n)
                      , h = n - o;
                    (a.match(t.tokenizer.separator) || n == i) && (h > 0 && s.push(new t.Token(r.slice(o, n),{
                        position: [o, h],
                        index: s.length
                    })),
                    o = n + 1)
...
`, e)
            ...
            t.Pipeline.load = function(e) {
                ...
                return e.forEach(function(i) {
                    var s = t.Pipeline.registeredFunctions[i];
                    if (s)
                        r.add(s);
                    else
                        throw new Error("Cannot load unregistered function: " + i)
                }),
                r
            }
            ,
            ...
            t.Pipeline.prototype.run = function(e) {
                for (var r = this._stack.length, i = 0; i < r; i++) {
                    var s = this._stack[i];
                    e = e.reduce(function(n, o, a) {
                        var h = s(o, a, e);
                        return h === void 0 || h === "" ? n : n.concat(h)
                    }, [])
                }
                return e
            }
            ...
            t.Vector.prototype.positionForIndex = function(e) {
                if (this.elements.length == 0)
                    return 0;
                for (var r = 0, i = this.elements.length / 2, s = i - r, n = Math.floor(s / 2), o = this.elements[n * 2]; s > 1 && (o < e && (r = n),
                o > e && (i = n),
                o != e); )
                    s = i - r,
                    n = r + Math.floor(s / 2),
            ...
            ,
            t.Vector.prototype.upsert = function(e, r, i) {
                this._magnitude = 0;
                var s = this.positionForIndex(e);
                this.elements[s] == e ? this.elements[s + 1] = i(this.elements[s + 1], r) : this.elements.splice(s, 0, e, r)
            }
            ,
            t.Vector.prototype.magnitude = function() {
                if (this._magnitude)
                    return this._magnitude;
                for (var e = 0, r = this.elements.length, i = 1; i < r; i += 2) {
            ...
            t.Vector.prototype.dot = function(e) {
                for (var r = 0, i = this.elements, s = e.elements, n = i.length, o = s.length, a = 0, h = 0, u = 0, d = 0; u < n && d < o; )
                    a = i[u],
                    h = s[d],
                    a < h ? u += 2 : a > h ? d += 2 : a == h && (r += i[u + 1] * s[d + 1],
                    u += 2,
                    d += 2);
                return r
            }
            ...
            t.Vector.prototype.toArray = function() {
                for (var e = new Array(this.elements.length / 2), r = 1, i = 0; r < this.elements.length; r += 2,
                i++)
                    e[i] = this.elements[r];
                return e
            }
            ...
            t.stemmer = function() {
                var e = {
                  ...
                  , P = /.$/
                  , O = /(at|bl|iz)$/
                  , C = new RegExp("([^aeiouylsz])\\1$")
                  , I = new RegExp("^" + n + s + "[^aeiouwxy]$")
                  , V = /^(.+?[^aeiou])y$/
                  ...
                  , T = /^(.+?)e$/
                  , N = /ll$/
                  , A = new RegExp("^" + n + s + "[^aeiouwxy]$")
                  , b = function(l) {
                    var y, B, R, c, g, z, j;
                    if (l.length < 3)
                        return l;
                    if (R = l.substr(0, 1),
                    R == "y" && (l = R.toUpperCase() + l.substr(1)),
                    c = k,
                    g = m,
                    c.test(l) ? l = l.replace(c, "$1$2") : g.test(l) && (l = l.replace(g, "$1$2")),
                    c = L,
                    g = _,
                    c.test(l)) {
                        var x = c.exec(l);
                        ...
                        z = C,
                        j = I,
                        g.test(l) ? l = l + "e" : z.test(l) ? (c = P,
                        l = l.replace(c, "")) : j.test(l) && (l = l + "e"))
                    }
                    if (c = V,
                    c.test(l)) {
                        var x = c.exec(l);
                    ...
                    c.test(l)) {
                        ...
                        g = v,
                        z = A,
                        (c.test(y) || g.test(y) && !z.test(y)) && (l = y)
                    }
                    return c = N,
                    g = p,
                    c.test(l) && g.test(l) && (c = P,
                    l = l.replace(c, "")),
                    R == "y" && (l = R.toLowerCase() + l.substr(1)),
                    l
                };
                return function(F) {
                    return F.update(b)
            ...
            t.TokenSet.fromArray = function(e) {
                for (var r = new t.TokenSet.Builder, i = 0, s = e.length; i < s; i++)
                    r.insert(e[i]);
                return r.finish(),
                r.root
            }
            ...
            t.TokenSet.fromFuzzyString = function(e, r) {
                for (var i = new t.TokenSet, s = [{
                    ...
                    var n = s.pop();
                    if (n.str.length > 0) {
                        var o = n.str.charAt(0), a;
                        o in n.node.edges ? a = n.node.edges[o] : (a = new t.TokenSet,
                        n.node.edges[o] = a),
                        n.str.length == 1 ? a.final = !0 : s.push({
                            node: a,
                            editsRemaining: n.editsRemaining,
                            str: n.str.slice(1)
                        })
                    }
                    if (n.editsRemaining > 0 && n.str.length > 1) {
                        var o = n.str.charAt(1), h;
                        o in n.node.edges ? h = n.node.edges[o] : (h = new t.TokenSet,
                        n.node.edges[o] = h),
                        n.str.length <= 2 ? h.final = !0 : s.push({
                            node: h,
                            editsRemaining: n.editsRemaining - 1,
                            str: n.str.slice(2)
                        })
                    }
                    if (n.editsRemaining > 0 && n.str.length == 1 && (n.node.final = !0),
                    n.editsRemaining > 0 && n.str.length >= 1) {
                        if ("*"in n.node.edges)
                            var u = n.node.edges["*"];
                        else {
                        ...
                        n.str.length == 1 ? u.final = !0 : s.push({
                            node: u,
                            editsRemaining: n.editsRemaining - 1,
                            str: n.str.slice(1)
                        })
                    }
                    if (n.editsRemaining > 0) {
                        if ("*"in n.node.edges)
                            var d = n.node.edges["*"];
                        else {
                        ...
                        n.str.length == 0 ? d.final = !0 : s.push({
                            node: d,
                            editsRemaining: n.editsRemaining - 1,
                            str: n.str
                        })
                    ...
                    if (n.editsRemaining > 0 && n.str.length > 1) {
                        var f = n.str.charAt(0), p = n.str.charAt(1), v;
                        p in n.node.edges ? v = n.node.edges[p] : (v = new t.TokenSet,
                        n.node.edges[p] = v),
                        n.str.length == 1 ? v.final = !0 : s.push({
                            node: v,
                            editsRemaining: n.editsRemaining - 1,
                            str: f + n.str.slice(2)
                        })
            ...
            t.TokenSet.fromString = function(e) {
                for (var r = new t.TokenSet, i = r, s = !1, n = 0, o = e.length; n < o; n++) {
                    var a = e[n]
                      , h = n == o - 1;
                    if (a == "*")
                        s = !0,
            ...
            t.TokenSet.prototype.toString = function() {
                if (this._str)
                    return this._str;
                for (var e = this.final ? "1" : "0", r = Object.keys(this.edges).sort(), i = r.length, s = 0; s < i; s++) {
                    var n = r[s]
                      , o = this.edges[n];
                    e = e + n + o.id
                }
            ...
            t.TokenSet.prototype.intersect = function(e) {
                for (var r = new t.TokenSet, i = void 0, s = [{
                    qNode: e,
                    output: r,
                    node: this
                }]; s.length; ) {
                    i = s.pop();
                    for (var n = Object.keys(i.qNode.edges), o = n.length, a = Object.keys(i.node.edges), h = a.length, u = 0; u < o; u++)
                        for (var d = n[u], f = 0; f < h; f++) {
                            var p = a[f];
                            if (p == d || d == "*") {
                                var v = i.node.edges[p]
                                  , Q = i.qNode.edges[d]
                                  , k = v.final && Q.final
                                  , m = void 0;
                                p in i.output.edges ? (m = i.output.edges[p],
                                m.final = m.final || k) : (m = new t.TokenSet,
                                m.final = k,
                                i.output.edges[p] = m),
                                s.push({
                                    qNode: Q,
            ...
            t.TokenSet.Builder.prototype.insert = function(e) {
                ...
                for (var s = 0; s < e.length && s < this.previousWord.length && e[s] == this.previousWord[s]; s++)
                    i++;
                this.minimize(i),
            ...
            t.TokenSet.Builder.prototype.minimize = function(e) {
                for (var r = this.uncheckedNodes.length - 1; r >= e; r--) {
                    var i = this.uncheckedNodes[r]
                      , s = i.child.toString();
                    s in this.minimizedNodes ? i.parent.edges[i.char] = this.minimizedNodes[s] : (i.child._str = s,
                    this.minimizedNodes[s] = i.child),
            ...
            t.Index.prototype.query = function(e) {
                ...
                e.call(r, r);
                for (var n = 0; n < r.clauses.length; n++) {
                    var o = r.clauses[n]
                      , a = null;
                    o.usePipeline ? a = this.pipeline.runString(o.term) : a = [o.term];
                    for (var h = 0; h < a.length; h++) {
                        var u = a[h];
                        o.term = u;
                        for (var d = t.TokenSet.fromClause(o), f = this.tokenSet.intersect(d).toArray(), p = 0; p < f.length; p++)
                            for (var v = f[p], Q = this.invertedIndex[v], k = Q._index, m = 0; m < o.fields.length; m++) {
                                var L = o.fields[m]
                                  , _ = Q[L]
                                  , P = Object.keys(_);
                                L in s || (s[L] = new t.Vector),
                                s[L].upsert(k, 1 * o.boost, function(b, F) {
                                    return b + F
                                });
                                for (var O = 0; O < P.length; O++) {
                                    var C = P[O], I = new t.FieldRef(C,L), V, E;
                                    V = _[C],
                                    E = new t.MatchData(v,L,V),
                                    I in i ? i[I].combine(E) : i[I] = E
                                }
                            }
                    }
                }
                for (var D = Object.keys(i), S = {}, n = 0; n < D.length; n++) {
                    var w = t.FieldRef.fromString(D[n])
                      , T = w.docRef
                      , N = this.fieldVectors[w]
                      , A = s[w.fieldName].similarity(N);
                    T in S ? (S[T].score += A,
                    S[T].matchData.combine(i[w])) : S[T] = {
                        ref: T,
                        score: A,
                        matchData: i[w]
                    }
            ...
            t.Index.prototype.toJSON = function() {
                var e = Object.keys(this.invertedIndex).sort().map(function(i) {
                    return [i, this.invertedIndex[i]]
                }, this)
                  , r = Object.keys(this.fieldVectors).map(function(i) {
                    return [i, this.fieldVectors[i].toJSON()]
                }, this);
                return {
                    version: t.version,
                    fields: this.fields,
            ...
            ,
            t.Builder.prototype.field = function(e) {
                this._fields.push(e)
            }
            ,
            ...
            t.Builder.prototype.add = function(e) {
                ...
                for (var i = 0; i < this._fields.length; i++) {
                    var s = this._fields[i]
                      ...
                      , h = new t.FieldRef(r,s)
                      , u = Object.create(null);
                    this.fieldTermFrequencies[h] = u,
                    this.fieldLengths[h] = 0,
                    this.fieldLengths[h] += a.length;
                    for (var d = 0; d < a.length; d++) {
                        var f = a[d];
                        if (u[f] == null && (u[f] = 0),
                        u[f] += 1,
                        this.invertedIndex[f] == null) {
                            var p = Object.create(null);
                            p._index = this.termIndex,
                            this.termIndex += 1;
                            for (var v = 0; v < this._fields.length; v++)
                                p[this._fields[v]] = Object.create(null);
                            this.invertedIndex[f] = p
                        }
                        this.invertedIndex[f][s][r] == null && (this.invertedIndex[f][s][r] = Object.create(null));
                        for (var Q = 0; Q < this.metadataWhitelist.length; Q++) {
                            var k = this.metadataWhitelist[Q]
                              , m = f.metadata[k];
                            this.invertedIndex[f][s][r][k] == null && (this.invertedIndex[f][s][r][k] = []),
                            this.invertedIndex[f][s][r][k].push(m)
                        }
                    }
                }
            }
            ...
            t.Builder.prototype.calculateAverageFieldLengths = function() {
                for (var e = Object.keys(this.fieldLengths), r = e.length, i = {}, s = {}, n = 0; n < r; n++) {
                    var o = t.FieldRef.fromString(e[n])
                      , a = o.fieldName;
                    s[a] || (s[a] = 0),
                    s[a] += 1,
                    i[a] || (i[a] = 0),
            ...
            t.Builder.prototype.createFieldVectors = function() {
                for (var e = {}, r = Object.keys(this.fieldTermFrequencies), i = r.length, s = 0; s < i; s++) {
                    for (var n = t.FieldRef.fromString(r[s]), o = n.fieldName, a = this.fieldLengths[n], h = new t.Vector, u = this.fieldTermFrequencies[n], d = Object.keys(u), f = d.length, p = 0; p < f; p++) {
                        var v = d[p]
                          , Q = u[v]
                          , k = this.invertedIndex[v]._index
                          , m = t.idf(this.invertedIndex[v], this.documentCount)
                          , L = m * ((this._k1 + 1) * Q) / (this._k1 * (1 - this._b + this._b * (a / this.averageFieldLength[o])) + Q)
                          , _ = Math.round(L * 1e3) / 1e3;
                        h.insert(k, _)
                    }
                    e[n] = h
                }
            ...
            ,
            t.MatchData = function(e, r, i) {
                for (var s = Object.create(null), n = Object.keys(i), o = 0; o < n.length; o++) {
                    var a = n[o];
                    s[a] = i[a].slice()
                }
            ...
            t.MatchData.prototype.combine = function(e) {
                for (var r = Object.keys(e.metadata), i = 0; i < r.length; i++) {
                    var s = r[i]
                      , n = Object.keys(e.metadata[s]);
                    this.metadata[s] == null && (this.metadata[s] = Object.create(null));
                    for (var o = 0; o < n.length; o++) {
                        var a = n[o]
                          , h = Object.keys(e.metadata[s][a]);
                        this.metadata[s][a] == null && (this.metadata[s][a] = Object.create(null));
                        for (var u = 0; u < h.length; u++) {
                            var d = h[u];
                            this.metadata[s][a][d] == null ? this.metadata[s][a][d] = e.metadata[s][a][d] : this.metadata[s][a][d] = this.metadata[s][a][d].concat(e.metadata[s][a][d])
                        }
                    }
                }
            }
            ...
            ,
            t.QueryParseError = function(e, r, i) {
            ...
            t.QueryLexer.prototype.sliceString = function() {
                for (var e = [], r = this.start, i = this.pos, s = 0; s < this.escapeCharPositions.length; s++)
                    i = this.escapeCharPositions[s],
                    e.push(this.str.slice(r, i)),
                    r = i + 1;
            ...
            t.QueryParser.prototype.parse = function() {
                ...
                for (var e = t.QueryParser.parseFieldOrTerm; e; )
                    e = e(this);
                return this.query
            }
            ,
            ...
            t.QueryParser.parseFieldOrTerm = function(e) {
                ...
                if (r != null)
                    ...
                    default:
                        ...
                        new t.QueryParseError(i,r.start,r.end)
                    }
            }
            ,
            t.QueryParser.parseField = function(e) {
                ...
                if (r != null) {
                    if (e.query.allFields.indexOf(r.str) == -1) {
                        var i = e.query.allFields.map(function(o) {
                            return "'" + o + "'"
                        }).join(", ")
                          , s = "unrecognised field '" + r.str + "', possible fields: " + i;
                        throw new t.QueryParseError(s,r.start,r.end)
                    }
                    e.currentClause.fields = [r.str];
                    var n = e.peekLexeme();
                    if (n == null) {
                        var s = "expecting term, found nothing";
                        throw new t.QueryParseError(s,r.start,r.end)
                    }
                    switch (n.type) {
                    case t.QueryLexer.TERM:
                        return t.QueryParser.parseTerm;
                    default:
                        var s = "expecting term, found '" + n.type + "'";
            ...
            t.QueryParser.parseTerm = function(e) {
                ...
                if (r != null) {
                    ...
                    default:
                        var s = "Unexpected lexeme type '" + i.type + "'";
            ...
            ,
            function(e, r) {
                typeof define == "function" && define.amd ? define(r) : typeof q == "object" ? M.exports = r() : e.lunr = r()
            }(this, function() {
                return t
            })
        }
    ...
    (function() {
        ...
        s.open("GET", "../search-stopwords.json"),
        s.onload = function() {
            this.status == 200 && (r = JSON.parse(this.responseText),
            o())
        }
        ,
        s.send();
        var n = new XMLHttpRequest;
        n.open("GET", "../index.json"),
        n.onload = function() {
            this.status == 200 && (i = JSON.parse(this.responseText),
            o(),
            postMessage({
                e: "index-ready"
            }))
        ...
        onmessage = function(h) {
            // console.log("Search keywords" + h.data.q);
            var u = h.data.q
              , d = e.search(u)
              , f = [];
        ...
        ;
        function o() {
            r !== null && !a(i) && (e = t(function() {
                this.pipeline.remove(t.stopWordFilter),
                this.ref("href"),
                this.field("title", {
                    boost: 50
                }),
                ...
                for (var h in i)
                    i.hasOwnProperty(h) && this.add(i[h]);
                var u = t.generateStopWordFilter(r);
                t.Pipeline.registerFunction(u, "docfxStopWordFilter"),
                this.pipeline.add(u),
                this.searchPipeline.add(u)
            }))
        }
        function a(h) {
            if (!h)
